...
class Pizza:
    ...
    def __str__(self):
        return f"Pizza(Size: {self.pizza_size}, Cheese: {self.cheese}, Pepperoni: {self.pepperoni}, Mushrooms: {self.mushrooms}, Extra Toppings: {self.extra_toppings})"

class PizzaBuilder:
    def __init__(self):
        self.pizza = Pizza()

    def set_size(self, pizza_size):
        self.pizza.pizza_size = pizza_size
...
```python
class Box:
    def __init__(self, box_length, box_width):
        self.box_length = box_length
        self.box_width = box_width

    def set_dimensions(self, box_length, box_width):
        self.box_length = box_length
        self.box_width = box_width
        return self # returning the class object itself

box = Box(5, 10)
box.set_dimensions(7, 14).box_length = 8
print(box.box_length, box.box_width)
```
...
person1 = Person.from_age("Josh", 25)
person2 = Person.from_birth_year("John", 1980)
...
person1 = Person.factory.from_age("Josh", 25)
person2 = Person.factory.from_birth_year("John", 1980)
...
class Car:
    def __init__(self, model, colour, engine):
        self.model = model
        self.colour = colour
        self.engine = engine
    ...
    def __str__(self):
        return f"{self.colour} {self.model} with {self.engine} engine"

car1 = Car("Tesla Model S", "Red", "Electric") # creating an original object

car2 = car1.clone() # cloning the object
car2.colour = "Blue" # modifying the cloned object
...
class CarFactory:
    ...
    @classmethod
    def new_car(cls, key, model, colour):
