...
city_populations = {"Suma": 5000, "Krasnystaw": 3000, "Chelm": 10000}
...
```python
def counter():
    countt = 0 # this variable is preserved across all calls
    def increment():
        nonlocal countt # referring to the "countt" variable in the enclosing scope
        countt += 1
        return countt
    return increment
